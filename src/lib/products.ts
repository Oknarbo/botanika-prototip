...
export const products: Product[] = [
  {
    ...
    image: getProductImage("growbox", 0),
    inStock: true,
    phase: "sve_faze",
  },
  {
    ...
    image: getProductImage("growbox", 1),
    inStock: true,
    phase: "sve_faze",
  },
  {
    ...
    image: getProductImage("rasvjeta", 0),
    inStock: true,
    phase: "sve_faze",
  },
  {
    ...
    image: getProductImage("rasvjeta", 1),
    inStock: true,
    phase: "sve_faze",
  },
  {
    ...
    image: getProductImage("ventilacija", 0),
    inStock: true,
    phase: "sve_faze",
  },
  {
    ...
    image: getProductImage("ventilacija", 1),
    inStock: true,
    phase: "sve_faze",
  },
  {
    ...
    image: getProductImage("supstrat", 1),
    inStock: true,
    phase: "vegetacija",
  },
  {
    ...
    image: getProductImage("supstrat", 2),
    inStock: true,
    phase: "vegetacija",
  },
  {
    ...
    image: getProductImage("supstrat", 0),
    inStock: true,
    phase: "sve_faze",
  },
  {
